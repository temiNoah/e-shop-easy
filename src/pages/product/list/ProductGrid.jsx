...
function ProductGrid(props) {
    ...
    const { getCarList, getAll, searchCars, deleteCar, deleteAll } = state.MockAPI//state.ProductAPI;
                ...
                return (
                    <div className="cellAction">
                        ...
                        <div
                            ...
                            onClick={
                                () => props.onClick(
                                    { name: "view", path: `/view/${row.id}`, content: props.configs.filter(config => config.name == "view")[0].content }
                                )
                            }
                            style={{ curson: "pointer" }}>
                            {/* View */}
